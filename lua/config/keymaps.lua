...
vim.api.nvim_set_keymap(
  ...
  { noremap = true, silent = true, desc = "Show LaTeX popup" }
)
vim.api.nvim_set_keymap(
  "n",
  "<leader>mt",
  ":lua require('nabla').toggle_virt()<CR>",
  { noremap = true, silent = true, desc = "Toggle LaTeX virtual text" }
)
vim.api.nvim_set_keymap(
  "n",
  "<leader>mv",
...
vim.api.nvim_set_keymap(
  "n",
  "<leader>kp",
  ":lua require('knap').process_once()<CR>",
  { noremap = true, silent = true, desc = "Process LaTeX once" }
)
vim.api.nvim_set_keymap(
  "n",
  "<leader>kc",
  ":lua require('knap').close_viewer()<CR>",
  { noremap = true, silent = true, desc = "Close LaTeX viewer" }
)
vim.api.nvim_set_keymap(
  "n",
  "<leader>kt",
  ":lua require('knap').toggle_autopreviewing()<CR>",
...
vim.api.nvim_set_keymap(
  ...
  "<leader>sg",
  "zg",
  { noremap = true, silent = true, desc = "Add word to dictionary (good)" }
)
vim.api.nvim_set_keymap(
  "n",
  "<leader>sw",
  "zw",
  { noremap = true, silent = true, desc = "Mark word as misspelled (wrong)" }
)
vim.api.nvim_set_keymap(
  "n",
  "<leader>sG",
  "zG",
  { noremap = true, silent = true, desc = "Add word to session dictionary" }
)
vim.api.nvim_set_keymap(
  "n",
  "<leader>sW",
  "zW",
  { noremap = true, silent = true, desc = "Mark word as wrong for session" }
)
